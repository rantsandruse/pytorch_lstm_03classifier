...
class LSTMClassifier(nn.Module):
    ...
    # Note: we can implement in two ways:
    ...
    def forward(self, sentences, X_lengths):
        ...
        # Tagger --> Classifier change No.3:
        # Only get the last non-padding element; Reshape tag_scores so that this can be directly fed into
        # BCEWithLogitsLoss()
